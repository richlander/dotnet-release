...
[JsonUnmappedMemberHandling(JsonUnmappedMemberHandling.Disallow)]
[Description("A supported operating system distribution.")]
    ...
    IList<string> SupportedVersions)
{
    ...
    [Description("Support notes for distribution.")]
    public IList<string>? Notes { get; set; } = null;
}

[JsonUnmappedMemberHandling(JsonUnmappedMemberHandling.Disallow)]
[Description("Minimum supported libc versions.")]
public record SupportLibc(
    ...
    [property: Description("Source of the libc header files and libraries.")]
    string Source);
