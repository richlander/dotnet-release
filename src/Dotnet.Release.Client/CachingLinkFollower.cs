...
public class CachingLinkFollower : ILinkFollower
{
    ...
    private static JsonTypeInfo<T> GetTypeInfo<T>() where T : class
    {
        return typeof(T).Name switch
        {
            ...
            nameof(SdkDownloadInfo) => (JsonTypeInfo<T>)(object)SdkVersionIndexSerializerContext.Default.SdkDownloadInfo,
            nameof(DownloadsIndex) => (JsonTypeInfo<T>)(object)DownloadsIndexSerializerContext.Default.DownloadsIndex,
            nameof(ComponentDownload) => (JsonTypeInfo<T>)(object)DownloadsIndexSerializerContext.Default.ComponentDownload,
