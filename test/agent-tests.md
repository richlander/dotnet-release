...
**Tool:** `dotnet-release verify supported-os`
...
1. **Verify** — Run `dotnet-release verify supported-os <version>` for each active .NET version. The report categorizes issues as:
...
4. **Regenerate** — Run `dotnet-release generate supported-os <version> <core-path>/release-notes` to regenerate the markdown.
